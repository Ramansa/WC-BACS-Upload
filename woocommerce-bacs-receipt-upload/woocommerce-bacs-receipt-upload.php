...
final class WC_BACS_Receipt_Upload
{
    ...
    private array $rendered_order_received_upload_orders = [];
    ...
    public function __construct()
    {
        ...
        add_action('woocommerce_before_thankyou', [$this, 'render_order_received_upload_form'], 1);
    ...
    public function render_order_received_upload_form($order_or_id): void
    {
        ...
        if (in_array($order_id, $this->rendered_order_received_upload_orders, true)) {
            return;
        }
        $this->rendered_order_received_upload_orders[] = $order_id;
